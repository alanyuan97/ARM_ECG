...
window_length = 0.15; %s, PAN TOMPKINS paper chooses N so that the length of window is 150ms
N = window_length*f_s;
...
plot(ECG);
subplot(2,2,2);
plot(preprocessed1(1:1000));
subplot(2,2,3);
plot(preprocessed3(1:1000));
subplot(2,2,4);
...
figure;
stem(out(1:1000)'.*preprocessed4(1:1000))
hold on
grid on
grid minor
plot(preprocessed4(1:1000))
